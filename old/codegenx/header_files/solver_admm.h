#ifndef _SOLVER_ADMM__H__
#define _SOLVER_ADMM__H__

/************************************************************************
 * function name   : solver_admm                                        *  
 * -------------------------------------------------------------------- *
 * return type     : none                                               *  
 * -------------------------------------------------------------------- *
...
int solver_admm(int mr, int mc, int lr, int lc, int mir, int mic, int lir, int lic, int slr, int slc, int slir, int slic, int alr, int alc,
