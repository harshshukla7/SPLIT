function codegen_fama(filename)
...
fprintf(fw, '#include "FAMA_matrices.h"\n\n');

% main codegen: fama
fprintf(fw, '/******************************************\n');
fprintf(fw, '*          RUN FAMA ALGORITHM             *\n');
fprintf(fw, '*******************************************/\n\n');
...
fprintf(fw, '\t // parameters in Nesterov acceleration\n');
fprintf(fw, '\t float beta = 1, beta_k = 1; \n\n');
