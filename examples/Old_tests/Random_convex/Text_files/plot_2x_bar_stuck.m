...
switch algo
    ...
    case 'ADMM'
        ...
        for i=1:length(kk)
            ...
            kkk = kk{i};
            tp (1,1:2) = [ A_ldlmat(kkk,5)/A_ldlmat(kkk,4), (A_ldlmat(kkk,6)-A_ldlmat(kkk,5))/A_ldlmat(kkk,4)];
            tp (2,1:2) = [ A_ldlss(kkk,5)/A_ldlss(kkk,4), (A_ldlss(kkk,6)-A_ldlss(kkk,5))/A_ldlss(kkk,4)];
            tp (3,1:2) = [ A_invert(kkk,5)/A_invert(kkk,4), (A_invert(kkk,6)-A_invert(kkk,5))/A_invert(kkk,4)];
            tp (4,1:2) = [ A_ldl_lp(kkk,5)/A_ldl_lp(kkk,4), (A_ldl_lp(kkk,6)-A_ldl_lp(kkk,5))/A_ldl_lp(kkk,4)];
    ...
    case 'FPDA'
        ...
        for i=1:length(kk)
            ...
            kkk = kk{i};
            tp (1,1:2) = [ A_cholmat(kkk,5)/A_cholmat(kkk,4), (A_cholmat(kkk,6)-A_cholmat(kkk,5))/A_cholmat(kkk,4)];
            tp (2,1:2) = [ A_ldlss(kkk,5)/A_ldlss(kkk,4), (A_ldlss(kkk,6)-A_ldlss(kkk,5))/A_ldlss(kkk,4)];
            tp (3,1:2) = [ A_invert(kkk,5)/A_invert(kkk,4), (A_invert(kkk,6)-A_invert(kkk,5))/A_invert(kkk,4)];
            tp (4,1:2) = [ A_ldllp(kkk,5)/A_ldllp(kkk,4),(A_ldllp(kkk,6)-A_ldllp(kkk,5))/A_ldllp(kkk,4)   ];
