...
switch algo
    ...
    case 'FAMA'
        fileID = fopen('FAMA_KKT_invert.txt','r');
        ...
        fileID = fopen('FAMA_KKT_ldlmat.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('FAMA_KKT_ldlss.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('FAMA_KKT_ldl_lp.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
    ...
    case 'ADMM'
        ...
        fileID = fopen('ADMM_KKT_invert.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('ADMM_KKT_ldl.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('ADMM_KKT_ldl_ss.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('ADMM_KKT_ldl_lp.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
    ...
    case 'FPDA'
        ...
        fileID = fopen('FPDA_chol_invert.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('FPDA_chol_ldl.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('FPDA_chol_llt.txt','r');
        formatSpec = '%d %d %d %f %f %f %f %f %f';
        sizeA = [9 Inf];
        ...
        fileID = fopen('FPDA_chol_CLPACK_final.txt','r');
