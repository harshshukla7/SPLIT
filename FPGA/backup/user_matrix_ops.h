...
void vector_constant_addition(double *y, const double *x, double constant, const int len);
#if 0
void divide_vector_elements(const double *y, const double *x, const int len );
