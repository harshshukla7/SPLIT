...
if(strcmp(settings.precond,'yes'))
    ...
    Ld = settings.E * dat.L;
    sd.add_function(...
        coderFunc_times('custom_mult_Ldtrans', (Ld'), 'Astr', 'Ldtrans', 'method', Mat_Vec));
...
if(strcmp(settings.precond,'no'))
    sd.add_function(...
        coderFunc_times('custom_mult_Ltrans', (dat.L'), 'Astr', 'Ltrans', 'method', Mat_Vec));
...
if(strcmp(settings.precond,'yes'))
    ...
    % workDual = L*x
    sd.add_function(coderFunc_times('custom_mult_Ld', (Ld), ...
...
if(strcmp(settings.precond,'no'))
    % workDual = L*x
    sd.add_function(coderFunc_times('custom_mult_L', full(dat.L), ...
