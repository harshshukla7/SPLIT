...
#define PL_VEC_IN_IN_VECTOR_LENGTH 5
#define PL_MAT_IN_IN_VECTOR_LENGTH 25
#define PL_VEC_OUT_OUT_VECTOR_LENGTH 5

//SOC interface arrays lengths:
#define SOC_STATE0_IN_VECTOR_LENGTH 5
#define SOC_PRIMAL0_IN_VECTOR_LENGTH 5
#define SOC_DUAL0_IN_VECTOR_LENGTH 5
#define SOC_TOL_ITERATES_IN_VECTOR_LENGTH 4

#define SOC_PRIMAL_OUT_VECTOR_LENGTH 5
#define SOC_DUAL_OUT_VECTOR_LENGTH 5
#define SOC_AUX_PRIMAL_OUT_VECTOR_LENGTH 5
#define SOC_ITERATES_OUT_VECTOR_LENGTH 4
////////////////////////////////////////////////////////////
