...
int write_stimuli(double input_data[], unsigned packet_internal_ID)
{
	...
	{
	case 0: //pl_vec_in_in
		// store pl_vec_in_in into ../../ip_design/test/stimuli/split_project/pl_vec_in_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/split_project/pl_vec_in_in.dat","w+");

		for (i = 0; i < PL_VEC_IN_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
	...
	case 1: //pl_mat_in_in
		// store pl_mat_in_in into ../../ip_design/test/stimuli/split_project/pl_mat_in_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/split_project/pl_mat_in_in.dat","w+");

		for (i = 0; i < PL_MAT_IN_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
...
{
	system("vivado_hls -f ../../.metadata/split_project_ip_design_test.tcl");
}
...
int read_results(double output_data[], unsigned packet_internal_ID, unsigned packet_output_size)
{
	...
	case 0: //pl_vec_out_in
		// load ../../ip_design/test/results/split_project/pl_vec_out_out.dat
		pFile = fopen ("../../ip_design/test/results/split_project/pl_vec_out_out.dat","r");
