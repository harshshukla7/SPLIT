...
default_hardware = 'PL';
if ~isfield(settings, 'hardware'), settings.hardware = default_hardware; end
...
pd_concat_c = '/ip_design/src/user_prob_data.cpp';
pd_concat_h = '/ip_design/src/user_prob_data.h';

foo_concat_c = '/ip_design/src/foo_user.cpp';
foo_algo_c = which('foo_user_orig.cpp');
